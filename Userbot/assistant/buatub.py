...
async def cb_bayar_dulu(client, m, _):
    msg = f"""
<b><blockquote>✅ Jika anda sudah setuju dengan syarat & ketentuan, Silahkan hubungi 😈 @CowoGien untuk mendapatkan akses membuat userbot.</b></blockquote>
<b>Created by {Ads()}</b>"""
